...
const authRegister = async (request, response) => {
    ...
    try {
        ...
        let country = { en: 'Unknown' };
        await satelize.satelize({ ip: ips[0] }, (error, payload) => {
            if (!error && payload && payload.country) {
                country.en = payload.country;
            }
        });
